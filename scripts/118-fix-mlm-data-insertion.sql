...
-- 2. 存在するカラムのみを使用してデータを挿入
INSERT INTO mlm_ranks (rank_name, required_investment, max_line_requirement, other_lines_requirement, distribution_rate, bonus_rate, rank_order) VALUES
('なし', 0, 0, 0, 0, 0, 0),
('足軽', 1000, 0, 1000, 45, 45, 1),
('武将', 1000, 3000, 1500, 25, 25, 2),
('代官', 1000, 5000, 2500, 10, 10, 3),
('奉行', 1000, 10000, 5000, 6, 6, 4),
('老中', 1000, 50000, 25000, 5, 5, 5),
('大老', 1000, 100000, 50000, 4, 4, 6),
('大名', 1000, 300000, 150000, 3, 3, 7),
('将軍', 1000, 600000, 500000, 2, 2, 8);
...
-- 10. 確認
SELECT 'MLM system created successfully' as status;
