-- user_rank_historyをバックアップ→削除→修復→復元のアプローチ
...
UPDATE reward_applications SET user_id = '3aa5c0de-8d2c-40b0-bdb5-3687d026ca5c' WHERE user_id = '00000000-0000-0000-000000000001';
...
SELECT 
    '3aa5c0de-8d2c-40b0-bdb5-3687d026ca5c' as user_id,
    rank_id,
    achieved_at,
    created_at,
    updated_at
...
-- 最終検証
SELECT 'BACKUP-DELETE-RESTORE APPROACH COMPLETED!' as status;
...
-- user_rank_historyの復元確認
SELECT 'user_rank_history restored successfully:' as rank_restored;
SELECT COUNT(*) as restored_records
FROM user_rank_history 
WHERE user_id = '3aa5c0de-8d2c-40b0-bdb5-3687d026ca5c';

SELECT 'COMPLETE FINAL SUCCESS: kappystone.516@gmail.com authentication fixed!' as final_success;