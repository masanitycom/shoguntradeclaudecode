...
SELECT 
    ...
    (operation_start_date AT TIME ZONE 'UTC' AT TIME ZONE 'Asia/Tokyo')::date as jst_operation_start_date,
...
ORDER BY jst_operation_start_date;
...
GROUP BY (operation_start_date AT TIME ZONE 'UTC' AT TIME ZONE 'Asia/Tokyo')::date
ORDER BY COUNT(*) DESC, missing_week_start;
