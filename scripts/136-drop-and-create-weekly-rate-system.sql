...
DROP FUNCTION IF EXISTS set_weekly_rate(NUMERIC, DATE, UUID);
DROP FUNCTION IF EXISTS get_daily_rate_history(UUID);
...
-- 8. 結果確認
SELECT 'Weekly Rate System Created Successfully' as status;
