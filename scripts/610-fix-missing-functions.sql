...
-- 2. list_weekly_rates_backups関数を作成
...
-- 3. calculate_daily_rewards_for_week関数を作成（変数名を修正）
...
-- 5. force_daily_calculation関数を作成
...
SELECT 'Created missing functions for backup system' as status;
